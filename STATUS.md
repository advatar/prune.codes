...
- Qualified manifest-only execution selects 57 instances from 13 disjoint repositories (29 train / 8 probe / 20 evaluation; 6 / 3 / 4 repositories) with manifest SHA-256 `ccfbe787573dd51c688a92945d923f8d95c73e4811a78f35f9a8c6b1710075ce` and zero Prune pack calls.
- Added exact repo/base/HEAD/index-digest cache validation, durable pack caches and failure ledger, shared mutation-operation schedules, complete access/cost/transition evidence, exclusive result plus digest receipt creation, an evidence-only independent verifier, eight deliberate-corruption cases, and nine protocol unit tests. Release `ce-cli` builds successfully; protocol tests and a non-SWE synthetic index/pack shape smoke pass.
